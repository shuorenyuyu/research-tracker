...
[内容...]"""
    ...
    def _build_insights_prompt(self, paper: Dict, summary: str) -> str:
        ...
        return f"""基于以下前沿科技领域（AI/机器人、新能源/电池、生物技术、量子计算等）的学术论文，分析其投资价值和技术趋势（200-400字）：
...
2. 商业化潜力（可能的产品/服务方向）
3. 相关行业/公司（**必须提及具体行业名称（如：自动驾驶、医疗影像、智能制造、金融科技等）和代表性公司名称（如：OpenAI、特斯拉、商汤科技、百度、华为等）**）
4. 投资建议（关注点/风险提示）

用中文回答，重点突出投资相关信息。**务必在分析中包含具体的行业名称和公司名称。**"""
